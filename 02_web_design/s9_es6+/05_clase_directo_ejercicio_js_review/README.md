Usa un bucle para sumar el total de las ventas (sellCount) de todos los productos pintar en la página la media de ventas y el producto que mejor esté funcionando como producto estrella del mes
